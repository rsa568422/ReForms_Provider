...
public class CapacidadFacadeREST extends AbstractFacade<Capacidad> {
    ...
    public void create(Capacidad entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Capacidad entity) {
        super.edit(entity);
    }
    ...
    public Capacidad find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Capacidad> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
